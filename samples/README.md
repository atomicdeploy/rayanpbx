...
### Managed Blocks
All RayanPBX-generated configurations use managed blocks:
```ini
...
- ✅ Manual configurations outside blocks are preserved
- ✅ Easy identification of RayanPBX-managed sections
...
### Customization
You can add your own sections outside the managed blocks:
...
; BEGIN MANAGED - Extension 100
; RayanPBX will only modify this section
[100]
...
; END MANAGED - Extension 100
```
